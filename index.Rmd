...
- Página, gráficos, animaciones: propias vía [R](https://github.com/rafalopezv/SantaCruzCovid) y [Observable](https://observablehq.com/@rafalopezv/bar-chart-race)
- Usé el notebook original de [juba](https://observablehq.com/@juba/bar-chart-race) que originalmente viene de [Jhon Murdock](https://observablehq.com/@johnburnmurdoch/bar-chart-race). [A la copia (fork)](https://observablehq.com/@rafalopezv/bar-chart-race) le cambié un par de cosas y lo conecté a [R](https://github.com/rafalopezv/SantaCruzCovid) vía la librería [`robservable`](https://juba.github.io/robservable/)
